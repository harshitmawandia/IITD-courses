...
void BringUpLink (Ptr<Node> nodeA, Ptr<Node> nodeB, uint32_t interfaceA, uint32_t interfaceB)
{
...
int main (int argc, char **argv){
    ...
    Simulator::Schedule (Seconds (120), &BringUpLink, R1, R2, 2, 1);
    Simulator::Schedule (Seconds (120), &BringUpLink, R1, R3, 3, 1);
