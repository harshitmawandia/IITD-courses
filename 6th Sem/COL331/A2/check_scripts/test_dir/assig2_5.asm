...
_assig2_5:     file format elf32-i386
...
{   
  ...
  13:	c7 45 c8 05 00 00 00 	movl   $0x5,-0x38(%ebp)
  1a:	c7 45 cc 06 00 00 00 	movl   $0x6,-0x34(%ebp)
  21:	c7 45 d0 04 00 00 00 	movl   $0x4,-0x30(%ebp)
  28:	c7 45 d4 08 00 00 00 	movl   $0x8,-0x2c(%ebp)
    int exectime[4] = {1, 3, 15, 2};
  2f:	c7 45 d8 01 00 00 00 	movl   $0x1,-0x28(%ebp)
  36:	c7 45 dc 03 00 00 00 	movl   $0x3,-0x24(%ebp)
  3d:	c7 45 e0 0f 00 00 00 	movl   $0xf,-0x20(%ebp)
  44:	c7 45 e4 02 00 00 00 	movl   $0x2,-0x1c(%ebp)
  ...
  55:	89 c3                	mov    %eax,%ebx
    rate(parent_pid, 2);
  57:	50                   	push   %eax
  58:	e8 6e 03 00 00       	call   3cb <rate>
  ...
  88:	50                   	push   %eax
  89:	e8 3d 03 00 00       	call   3cb <rate>
